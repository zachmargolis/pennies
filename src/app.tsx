...
export function App() {
  ...
  return (
    <article>
      ...
      <p>
        We take pictures of coins we find on the ground (either in situ or once they've been picked
        up) and then message the pictures to a group chat with all of us. Almost all change is fair
      ...
      <p>
        ...
        visualizations. Most of the time we note what coins we find (such as "a scuffed penny" or "a
        dime and a nickel") but sometimes we forget, so I have to take a guess (a blurry dime and
        nickel with no reference are hard to tell apart).
      </p>
