_site: _site/index.html _site/screenshot-2019.jpg
...
_site/index.html: index.html _site/bundle.js _site/pennies.csv _site/styles.css $(d3_pre)
	mkdir -p _site
...
_site/preview.html: index.html _site/bundle.js _site/pennies.csv _site/styles.css
	mkdir -p _site
...
_site/styles.css: assets/stylesheets/styles.css
	mkdir -p _site
	cp $< $@
